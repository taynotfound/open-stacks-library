---
title: "Answer to Some Comments Made in Green Anarchist - Ted Kaczynski"
...
page_type: book
mirror_state: full
description: "I would like to comment on some statements that were made in reference to the Unabomber’s manifesto in GA 40–41. In an article on pages 21–22, Anti-Authoritarians Anonymous wrote: A return to undomesticated autonomous ways of living would n"
tags:
  - "anarchism"
  - "Ted Kaczynski"
  - "Unabomber"
  ...
  - "pdf"
files:
  - name: "Answer to Some Comments Made in Green Anarchist.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-ted-kaczynski-answer-to-some-comments-made-in-green-anarchist.pdf"
    hosted: true
  - name: "Answer to Some Comments Made in Green Anarchist.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-ted-kaczynski-answer-to-some-comments-made-in-green-anarchist.epub"
    hosted: true
---
...
> This text was transcribed by [[http://uncfc.org][Freedom Club]], an anti-industrial student group at the University of North Carolina at Chapel Hill. They can be found in Box 65 of the University of Michigan’s Special Collection’s Library (Labadie Collection).
...
I insist that the revolution against technology should not address issues of race, gender, sexual orientation, etc. There are several reasons for this.
 ...
 1. Even if all inequities of race, gender, etc. were eliminated, this would accomplish nothing toward the destruction of the techno-industrial system. In fact, doing away with race and gender discrimination would be *good* for the existing system because it would eliminate conflicts that interfere with the functioning of the system and would facilitate the process of integrating black people, women, etc. as obedient cogs in the social machine. Why do you think the mass media constantly feed us propaganda about equality of races, sexes, etc.? (See ISIF paragraphs 28, 29, and Note 4.)
