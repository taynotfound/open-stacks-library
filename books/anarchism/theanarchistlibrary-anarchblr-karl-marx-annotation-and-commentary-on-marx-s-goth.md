...
[Read on theanarchistlibrary.org](https://theanarchistlibrary.org/library/anarchblr-karl-marx-annotation-and-commentary-on-marx-s-gothakritik)
...
That somehow Marx (who, as we’ve pointed out, considers using the State as ‘narrow-minded’ and Socialism that does as ‘not even skin-deep’) makes an exception for the proletariat (despite just having stated that the answer does not lie in the ‘thousand-fold combination of the word ‘people’ with the word ‘State’.’)?

Or that Marx considers the State and the Dictatorship of the Proletariat to be two distinct things, of different quality , and by no means synonymous?
