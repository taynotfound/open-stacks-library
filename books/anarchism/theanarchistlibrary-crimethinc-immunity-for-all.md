...
date: "2020"
category: "anarchism"
source: "https://theanarchistlibrary.org/library/crimethinc-immunity-for-all"
source_name: "theanarchistlibrary.org"
page_type: book
mirror_state: none
language: "en"
description: "Invitation to a Strike"
tags:
  - "english"
  - "anarchism"
files:
  - name: "crimethinc-immunity-for-all.epub"
    type: "EPUB"
    url: "https://theanarchistlibrary.org/library/crimethinc-immunity-for-all.epub"
    hosted: false
---

[Read on theanarchistlibrary.org](https://theanarchistlibrary.org/library/crimethinc-immunity-for-all)
...
Here, we present a poster and two texts about the rent strike: the first from participants in a group offering countrywide coordination for the strike, the second from anarchists involved in rent strike organizing on the West Coast.

In the 21 st century, the feeling of home has become an increasingly precarious and temporary experience.
