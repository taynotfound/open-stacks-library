---
title: "An Anarchist Programme - Errico Malatesta"
...
page_type: book
mirror_state: full
description: "1. Aims and Objectives We believe that most of the ills that afflict mankind stem from a bad social organisation; and that Man could destroy them if he wished and knew how. Present society is the result of age-long struggles of man against"
tags:
  - "anarchism"
  - "introductory"
  - "classical"
  - "pdf"
files:
  - name: "An Anarchist Programme.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-errico-malatesta-an-anarchist-programme.pdf"
    hosted: true
  - name: "An Anarchist Programme.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-errico-malatesta-an-anarchist-programme.epub"
    hosted: true
---
...
Therefore:
 ...
 1. Abolition of government and of every power which makes the law and imposes it on others: therefore abolition of monarchies, republics, parliaments, armies, police forces, magistratures, and any institution whatsoever endowed with coercive powers.

 1. Organisation of social life by means of free association and federations of producers and consumers, created and modified according to the wishes of their members, guided by science and experience, and free from any kind of imposition which does not spring from natural needs, to which everyone, convinced by a feeling of overriding necessity, voluntarily submits.

 1. The means of life, for development and well-being, will be guaranteed to children and all who are prevented from providing for themselves.

 1. War on religions and all lies, even if they shelter under the cloak of science. Scientific instruction for all to advanced level.

 1. War on rivalries and patriotic prejudices. Abolition of frontiers; brotherhood among all peoples.

 1. Reconstruction of the family, as will emerge from the practice of love, freed from every legal tie, from every economic and physical oppression, from every religious prejudice.
