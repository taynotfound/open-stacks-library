---
title: "Interview with Individualist anarchist prisoners"
author: "Culmine, Aversión"
date: "2021"
category: "anarchism"
source: "https://theanarchistlibrary.org/library/aversion-interview-with-individualist-anarchist-prisoners"
source_name: "theanarchistlibrary.org"
page_type: book
mirror_state: none
language: "en"
description: "From Aversión –Publicación Anarquista-issue 8, May 2013. Translated from Italian by act for freedom now/B.pd Retrieved on 6th March 2021 from actforfree.nostate.net"
tags:
  - "english"
  - "anarchism"
files:
  - name: "aversion-interview-with-individualist-anarchist-prisoners.epub"
    type: "EPUB"
    url: "https://theanarchistlibrary.org/library/aversion-interview-with-individualist-anarchist-prisoners.epub"
    hosted: false
---

[Read on theanarchistlibrary.org](https://theanarchistlibrary.org/library/aversion-interview-with-individualist-anarchist-prisoners)

1 – Aversi ón : In recent years, for reasons we won’t analyse here, which mainly concern the direction the system is taking, but which affect our ways of relating with one another, blogs and websites have been taking on the task that our publications used to fulfil in the past. In your opinion, how does this affect the struggle and its perception?
...
2 – Aversi ón : It seems that today internet includes many aspects of our existence and profoundly affects human relations, thus contributing to isolation, atomization and alienation. Don’t you think that there is a lack of critique on this instrument in the anarchist environment?
...
3 – Aversi ón : As a matter of fact, Culmine is the first known case of repression against an anarchist blog of counter-information. What do you think is the reason for this? Why Culmine and not some other blogs or sites?
...
5 – Aversi ón : A new concept of anarchism of action strongly influenced by the web is coming to the fore. There are ways of doing and saying which materialize dynamics resembling poorly assimilated reproductions or mere ‘web games’, even if not all of them can be regarded as ‘harmful’.
...
6 – Aversi ón : Many of us became anarchist by participating in talks, writing letters to prisoners, reading pamphlets, visiting anarchist libraries, subscribing to periodicals from the other side of the planet, discussing with old saboteurs and fighters, etc… But at the moment formation occurs mainly through blogs and social networks. What’s your opinion on this point?
...
7 – Aversi ón : This interview is meant to be like a stone thrown in the air with the aim of creating a debate. Would you like to add anything else?
...
– Elisa Di Bernardo . anarchist prisoner c/c Rebibbia Femminile via Bartolo Longo, 92 00156 Roma Italy

Stefano Gabriele Fosco , Individualist anarchist prisoner prison of Ferrara Via Arginone 327 44122 Ferrara Italy
