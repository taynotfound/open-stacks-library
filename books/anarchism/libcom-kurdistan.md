...
date: ""
category: "anarchism"
source: "https://libcom.org/library/kurdistan"
source_name: "libcom.org"
page_type: book
mirror_state: none
language: "en"
description: "Voici encore un texte critique sur la &quot;Révolution au Rojava&quot; co-écrit par le camarade Gilles Dauvé. Ce texte aborde des questions essentielles telles que l’armement, le nationalisme, la vie quotidienne, la structure sociale, les milices et le rôle des femmes, l’enthousiasme des milieux lib"
tags:
  - "en"
  - "anarchism"
  - "libcom"
...
[Read on libcom.org](https://libcom.org/library/kurdistan)

Voici encore un texte critique sur la "Révolution au Rojava" co-écrit par le camarade Gilles Dauvé. Ce texte aborde des questions essentielles telles que l’armement, le nationalisme, la vie quotidienne, la structure sociale, les milices et le rôle des femmes, l’enthousiasme des milieux libertaires, la critique de l’Etat... Un important bémol est (comme toujours) la faiblesse de compréhension de la nature fondamentalement capitaliste de la démocratie, qu’elle soit "bourgeoise" ou "ouvrière", qu’elle soit parlementaire ou directe... Bonne lecture... Un amateur pour le traduire en anglais???

Initialement publié sur le blog DDT21 : http://ddt21.noblogs.org/?page_id=324

« Il y a des périodes où l’on ne peut rien, sauf ne pas perdre la tête » Louis Mercier-Véga, La Chevauchée anonyme
...
This really doesn't add that much to the recent text by Il Lato Cattivo, here in English translation - "The "Kurdish Question", ISIS, USA, Etc." . (I also thought this was somewhere on this site, but can't find it immediately).

It suffers from the same errors as the Italian text, particularly as regards the Zapatistas, for example, as "defending traditional culture". The revolutionary declaration on women of the 1 Jan 1994 was not a defence of traditional culture, but a programme for it's revolutionisation, at least on the level of gender relations.

And this is a common pattern, not just the retro-Menshevism I criticised re the Italians (I will find the link to that thread and add below, as all the criticisms made there also relate to Dauvé's piece*, so they can be recycled), but generally the failure to deal, both in the Zaps and the KCK case, with "the gender question". From the AF piece, through Lato Cattivo and that "critical questions" piece, the same pattern recurs. Draw attention to the fetishisation of "gals with guns". And then... er... that's it. Because, and here is the irony, the reponse to the "gender question" is itself fetishistic. Because to look at the engagement with gender issues within Kurdish society (and Zapatista) - i.e. the efforts to oppose forced marriage and all the other formationally-specific partriachal practices that structure the actually existing, not-yet-liberal/fully-subsumed social structure, would require investigation, knowledge, above all the acceptance of class as social relation that dominates sociological structures and processes without nullifying them.

Herein lies the problem. What we are dealing with here is fundamental failure of social ontology. An inability to deal with social formations and real class relations in their concrete, historical reality. The question of history is already extinguished by the adoption of a Wallerstein-Cammatte notion of social time as geological time. The "K/T boundary" dividing world history between the eras of formal subsumption has already been crossed, therefore all society is liberal society, all class relations are identical to those of Paris, Rome, London or New York. Class composition is a meaningless problematic because class is always-already an unstructured "body without organs", trapped forever at the level of abstraction of Marx's capital, (and as understood as his chapter on class).

What we are clarifying here is not so much the status of struggles in Kurdistan or the Lacandon jungle, but the political/ontological bankruptcy of a morbid second wave socialism, as much within its ultraleft and anarchist epigones as amongst its more traditional bolshevik bearers.

edit: previous thread on Il Lato Cattivo text is here ---- * Actually Dauvé and comrade "L.T.", but I don't know who the latter is, and given Dauvé's current celebrity status in the anglophone ultra milieu, no doubt this will do down as "the Dauvé critique", as Guerre de Classe has already trailed it - bad luck L.T...

Done, an english translation available here: https://thesinisterquarter.wordpress.com/2015/02/16/kurdistan/

Well thanks to the translation; we now know that "social revolution" is property of anarchists. It is also very interesting that what social revolution is or what is its historical manifestations is never discussed in text but taken as a "self-evident truth" whose authority is obvious (to the audience of believers, I guess) As an attempt to historical discussion would inevitably start a comparative analysis of the emerging structures of an "social revolution" which would possibly show differences and similarities between democratic autonomy and "social revolution" (in their specific manifestations in different times and spaces). As such a task might provide (negative and positive) important political lessons for a struggle against current global capitalist hegemony, especially in different regions of the globe. Moreover it might open a discussion of difference between "self-government" and "state" (as Bookchin thought) whether it has any subsistence in political and historical terms (and not just theoretical terms). However we are safe from engaging in such hard tasks as it is always enough for die-hard "class" anarchists (it is the emphasis in the text, not mine) to compare ideals with real political processes (Thus reinforcing an ideal purism of anarchism which inevitably renders it as a western phenomenon based on some men and "a big but lost struggle"), and show hospitality to state to any form without engaging in defining it. This shows "some" western anarchists understand anarchism not as a force for betterment of human life here and now by the oppressed themselves by building more or less prefigurative forms of social organisation, but as a sort of prophecy or a belief in a ideal society and self "to come" (thus acting as priests of the truth and enlightening people on proper form of conduct [i.e political ideology and action], without bothering to learn anything back from living suffering struggling humans in return.) I guess this is the way to go for anti-statism, huh?

The other text referred to in the footnotes above and by ocelot is on libcom here: http://libcom.org/news/kurdish-question-isis-usa-etc-17112014

FYI: http://endnotes.org.uk/en/endnotes-the-history-of-subsumption
