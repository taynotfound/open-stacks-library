---
title: "Anarchist / Black Bloc Motivation - Anonymous"
author: "Anonymous"
date: "2001"
category: "anarchism"
...
page_type: book
mirror_state: full
description: "This anonymous article was found on the web. Many seem to be confused or angry at those who have used street fighting tactics in Genoa. By explaining the motivation behind using these street fighting tactics, especially from the Black Bloc"
tags:
  - "anarchism"
  - "anti-globalization"
  - "black bloc"
  ...
  - "pdf"
files:
  - name: "Anarchist / Black Bloc Motivation.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-anonymous-anarchist-black-bloc-motivation.pdf"
    hosted: true
  - name: "Anarchist / Black Bloc Motivation.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-anonymous-anarchist-black-bloc-motivation.epub"
    hosted: true
---
...
This isn’t just a dogmatic defense of the Bloc in Genoa. The Black Bloc made mistakes I’m sure, and there are issues on how the Bloc can weed out problems, however I still believe in the Black Bloc and it’s tactics for many good reasons, which are: 
 ...
 1. I believe that showing people fighting back against security forces isn’t in all cases disempowering or turns people uninvolved off.
 ...
 1. I think this movement has got as far as it has because of its diversity. The above groups that I have written above in the other points, while I disagree with them on some issues, I still welcome them to the movement, want to co-operate and agree not to interfere with their activities (a show of respect many anarchists don’t get in return).
...
Finally I would like to appeal to those who street fight and those who believe in non-violent action alike:
 ...
 1. We must stay united; without each other we are the isolated bland force that the state and capital has out maneuvered time and time again over most of the last 50 years. Each faction needs to actively avoid a split by influencing the members within each that move to create a division over dogmatic interpretations of ideology.

 1. We, forceful and non-violent direct actionists, need to work together to consider how to confront our oppressors in their planning our oppression, with the aim of disrupting/shutting them down non-violently ideally and primarily, but forcefully if necessary.

 1. We need to broaden our actions both in membership demographics and in tactics, including non-anti-summit actions. Radical change is unlikely to come about just through shutting down these meetings (but it would be a good start).
