---
title: "An Anarchist Response to Ebola: Visions and Questions - Carwil Bjork-James, Chuck Munson"
author: "Carwil Bjork-James, Chuck Munson"
...
page_type: book
mirror_state: full
description: "Key points: Part One - The current Ebola outbreak sprung up in places looted by capitalist industries, warfare among states, and the devaluing of African lives. - The absence of health care systems for all produces daily death that dwarfs"
tags:
  - "anarchism"
  - "disease"
  - "health"
  ...
  - "pdf"
files:
  - name: "An Anarchist Response to Ebola.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-carwil-bjork-james-chuck-munson-an-anarchist-response-to-ebola.pdf"
    hosted: true
  - name: "An Anarchist Response to Ebola.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-carwil-bjork-james-chuck-munson-an-anarchist-response-to-ebola.epub"
    hosted: true
---

# An Anarchist Response to Ebola: Visions and Questions

*by Carwil Bjork-James, Chuck Munson*
...
#### Key points: Part Two
 ...
 - Just as with the AIDS epidemic, grassroots movements can and should pressure state and corporate institutions to save lives today, while staying critical and building independent alternatives.

 - A future stateless society can and must maintain systems to support human health. These systems are generally more complex than other systems anarchists have maintained during moments of revolt, but doing so is feasible.

 - Too many anarchists offer critique and deconstruction under the banner of anarchism, but don’t speak as anarchists when they put forward large-scale alternatives. This has contributed to the idea that anarchist solutions are only local, low-tech, and limited.

 - On the other hand, health care systems, scientific research, and community systems of care reflect anarchist traditions of mutual aid, free association, and care for all people regardless of status or class.

 - Global recognition that #BlackLivesMatter means fighting back not just when Black lives are senselessly taken, but when insufficient value and material care are put forward to sustain them.
...
#### Part Two: Envisioning an Anarchist Alternative
...
#### What does confronting the Ebola outbreak mean?
...
#### How would a society without a state respond to Ebola?
...
How to avoid catching Ebola, The Guardian
...
Every Single Flu Vaccine Myth, Debunked, i09

A Herstory of the #BlackLivesMatter Movement, Feminist Wire
