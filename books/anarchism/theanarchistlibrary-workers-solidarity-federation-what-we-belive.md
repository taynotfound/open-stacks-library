...
date: "2021"
category: "anarchism"
source: "https://theanarchistlibrary.org/library/workers-solidarity-federation-what-we-belive"
source_name: "theanarchistlibrary.org"
page_type: book
mirror_state: none
language: "en"
description: "Retrieved on 28th October 2021 from struggle.ws"
tags:
  - "english"
  - "anarchism"
files:
  - name: "workers-solidarity-federation-what-we-belive.epub"
    type: "EPUB"
    url: "https://theanarchistlibrary.org/library/workers-solidarity-federation-what-we-belive.epub"
    hosted: false
---

[Read on theanarchistlibrary.org](https://theanarchistlibrary.org/library/workers-solidarity-federation-what-we-belive)

The struggle of the Black working class in South Africa is a struggle against the slave bondage of capitalism.

Capitalism is based on the ruling class minority (capitalists, generals, top officials, professional politicians) exploiting and oppressing the working class majority (workers of all grades, their families, rank and file soldiers, the unemployed, and the rural poor). The two classes have totally different interests- they are locked in class struggle.
...
The revolutionary general strike will establish a non-racial international working-class democracy: libertarian socialism. This will be based on federations of grassroots workplace and community councils, and defended by a workers army.
...
We proudly stand in the mass tradition of libertarian socialism (anarcho-syndicalism). Our movement has historically attracted millions world wide, because it serves the needs of the workers and the poor, not the power-seekers and exploiters. Today it is growing across the globe. If you agree- JOIN the WSF.
