...
date: "2023"
category: "anarchism"
source: "https://theanarchistlibrary.org/library/rasmus-hastbacka-let-s-build-class-unions"
source_name: "theanarchistlibrary.org"
page_type: book
mirror_state: none
language: "en"
description: "This article was first published in the US magazine Industrial Worker (on January 27, 2023). Also in Spanish. The article is based on a longer essay on the website Znetwork. An even shorter summary of the essay was written for Anarchist Library here. Photo below: Stockholm, May 1, 2022. Banner held "
tags:
  - "english"
  - "anarchism"
files:
  - name: "rasmus-hastbacka-let-s-build-class-unions.epub"
    type: "EPUB"
    url: "https://theanarchistlibrary.org/library/rasmus-hastbacka-let-s-build-class-unions.epub"
    hosted: false
---

[Read on theanarchistlibrary.org](https://theanarchistlibrary.org/library/rasmus-hastbacka-let-s-build-class-unions)
...
To maximize workers’ unity and the capacity for collective action, syndicalists stress that all trade unions should be independent of the political left – and, of course, independent of the right and center as well.
...
Read the long essay on Znetwork . More articles by the author can be found in Anarchist Library here .
