---
title: "Anarchist Organisation and the Organisation of Anarchists - Anarcho"
author: "Anarcho"
...
page_type: book
mirror_state: full
description: "An article from the early 1990s on ideas how the Glasgow Anarchist Group should organise itself. Rejecting both synthesis and platformist organisation, it suggests what is often called a class struggle anarchist group in the UK. Hopefully t"
tags:
  - "anarchism"
  - "organization"
  ...
  - "pdf"
files:
  - name: "Anarchist Organisation and the Organisation of Anarchists.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-anarcho-anarchist-organisation-and-the-organisation-of-anarchists.pdf"
    hosted: true
  - name: "Anarchist Organisation and the Organisation of Anarchists.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-anarcho-anarchist-organisation-and-the-organisation-of-anarchists.epub"
    hosted: true
---
...
In order to achieve this we should ensure:
 ...
 1. We regularly discuss anarchist ideas and how to apply them.

 1. We discuss past anarchist and labour movement history (those who do not learn the lessons of history are doomed to repeat them).

 1. We decide to produce a programme, outlining what anarchism is, who we are, how we operate and what we aim to do.
...
So, here is a few proposals for the meeting:
 ...
 1. Discuss the organisation of the group and its aims.

 1. Decide whether the idea of a written constitution and A&Ps are acceptable to the group.

 1. If so, delegate a group of comrades to draft a copy of both, taking into account the discussions.

 1. Organise a future meeting which will modify and finalise the finished copies (obviously, copies must be sent to all comrades before this meeting in a mailout).

 1. That all meetings (starting with this one) be minuted and any decisions documented and included in the mailout.
