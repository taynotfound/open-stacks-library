---
title: "Anarchismus und Alkohol: Extase vs. Intoxication: Für eine Welt der Verzauberung, oder für Anarchoholismus? - Crimethinc."
author: "Crimethinc."
date: "2015-09-17T17:31:21"
category: "anarchism"
source: "https://de.anarchistlibraries.net/library/crimethinc-anarchismus-und-alkohol"
source_name: "de.anarchistlibraries.net"
page_type: book
mirror_state: full
description: "Betrunken, dicht, zu, berauscht, blau, breit, voll, besoffen, knülle. Jeder hat von den Inuit gehört, die einhundert Worte für Schnee haben; wir haben einhundert Worte für betrunken. Wir verewigen unsere eigene Kultur der Niederlage. Ich s"
tags:
  - "deutsch"
  - "anarchism"
  - "Organisierung"
  ...
  - "pdf"
files:
  - name: "Anarchismus und Alkohol.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/talde-crimethinc-anarchismus-und-alkohol.pdf"
    hosted: true
  - name: "Anarchismus und Alkohol.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/talde-crimethinc-anarchismus-und-alkohol.epub"
    hosted: true
---

# Anarchismus und Alkohol: Extase vs. Intoxication: Für eine Welt der Verzauberung, oder für Anarchoholismus?

*von Crimethinc.*

> Original auf Englisch, Originaltitel: "Ecstasy v Intoxication: For a World of Enchantment, or anarchoholism?" in "Anarchy and Alcohol", ohne Ort, ohne Jahr, S. 1-8. Originalbroschüre unter: [[http://www.crimethinc.com/tools/downloads/pdfs/anarchy_and_alcohol_reading.pdf][www.crimethinc.com]].
...
Es heißt, als der berühmte Anarchist Oscar Wilde zum ersten Mal den Slogan *„wenn es beschämend ist, bestimmt zu werden, wie viel beschämender muss es dann sein seinen*ihren Bestimmer auszuwählen"* hörte, darauf antwortete: „Wenn es beschämend ist, den eigenen Meister auszuwählen, wie viel beschämender muss es dann sein selbst der eigene Meister zu sein!" Er meinte das sowohl als Kritik an Hierarchien an sich, als auch als Kritik am demokratischen Staat – leider kann diese geistreiche Bemerkung auch für so manch anarchistische Idee stehen, wenn diese in die Tat umgesetzt werden. Dies ist speziell dann war, wenn diese von Betrunkenen ausgeführt werden.
