---
title: "Whoever pays the piper calls the tune"
author: "Dermot Sreenan"
date: "2021"
category: "anarchism"
source: "https://theanarchistlibrary.org/library/dermot-sreenan-whoever-pays-the-piper-calls-the-tune"
source_name: "theanarchistlibrary.org"
page_type: book
mirror_state: none
language: "en"
description: "Crime and Punishment: An Anarchist View"
tags:
  - "english"
  - "anarchism"
files:
  - name: "dermot-sreenan-whoever-pays-the-piper-calls-the-tune.epub"
    type: "EPUB"
    url: "https://theanarchistlibrary.org/library/dermot-sreenan-whoever-pays-the-piper-calls-the-tune.epub"
    hosted: false
---

[Read on theanarchistlibrary.org](https://theanarchistlibrary.org/library/dermot-sreenan-whoever-pays-the-piper-calls-the-tune)
...
In the USA they have come up with a new definition for murder which depends on who commits it. A boss who saves money by not providing safety equipment for his workers is responsible for what is termed an “industrial death”. This happens if a worker dies at his place of work due to a work related task. This is not a criminal offence. The American public are bombarded with the latest homicide statistics but are not so well informed about how many “industrial deaths” occur in North America each year.
...
Childish notions that the police are there to protect and serve the community soon disappear upon experience. Their primary purpose is to serve and protect the state and it’s ruling class. Their use, over many years, to smash picket lines during strikes illustrates that point.
