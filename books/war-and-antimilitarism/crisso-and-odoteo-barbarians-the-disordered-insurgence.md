...
page_type: book
mirror_state: none
description: "Translator\u2019s Preface Barbarians by Chrissus and Odotheus is a text of some importance for anarchists and anyone else who sincerely desires the destruction of this social world of exploitation and domination. It presents "
tags:
...
*Barbarians* by Chrissus and Odotheus is a text of some importance
...
anti-globalization movement, *Empire* by Michael Hardt and
...
of the *power* of the “multitude”, their historical subject.
...
English. This allows them to place *Empire* in a context that
...
human and the machine” (*Empire,* p. 215) and, thus, the
acceptance of ourselves as cyborgs (see for example, *Empire,*
...
which *subject* us to the needs of the social institutions.
...
individuals, but of “groups and sets of humanity”[1] biopolitically
...
project *is* that of Empire. But once the barbaric sword of
...
have a project “*absolutely other*”: the total destruction of
...
having invented Marxism as a *lingua franca*[2]. Since ancient
...
newspeak describes as the *anti-globalization* movement: the
*Le monde diplomatique* collective and our Paduan professor to
...
the creation of the so-called movement for the Tobin tax[3]
(*Attac*) — various Italian sections of which now exist — owe
...
the White Overalls (*Tute bianche*), the Disobedient
(*Disobbedienti*) and so many other global citizens are little
soldiers. Reading any flyer from any *social forum*, one will
...
specific needs. *Empire* by Negri and Hardt is an exemplary
...
denunciation of the elements that escape its control.[4]
...
burden; when forced to expel it again, it called this refuse *civil
society*, decorating it with all the ideologies of the middle
...
*citoyen* of the French revolution, the subject of the
*polis*, the supporter of direct democracy), these democrats
...
way). The “movement of movements” is a *constituent* power,
i.e., a social surplus in relationship to *constituted* power,
...
of Spinoza’s concept of *potency*.[5] Its strategy is the
...
now *multitude*) and a thousand tricks. In fact, it is this
...
illusion, one that Negri shares with the leftist statists of *Le
Monde Diplomatique*. If both denounce “savage capitalism”, “fiscal
...
a *universal income for citizenship*. Thus, the less
...
to managerial language) expresses the *“becoming-woman*” of
...
Cacciari,[6] from the peasants of Chiapas to the small Venetian
...
material basis for the thing defined as *globalization*; and
...
of the decline of the State. What is changing is merely *one
specific* State form.
...
Who is the *European subject*? They are those populations and
social classes that want to build an absolute democracy on the plane
of Empire. What they propose is *counter-Empire*. [...] Thus
...
*against* globalization *in* globalization qualifying
itself (starting from the European space) as *counter-power*
with respect to the *capitalistic* hegemony of the Empire.”
(from *Political Europe Reasons for a necessity*, edited by H.
...
*MicroMega,* May 2001). In short, dear Senators, Rome is in
danger. Without the “dialectic” between social movements and
institutions, governments are “illegitimate”, thus *unsafe*. As
...
could become dangerous as a horde of *barbarians* — and descend
from the hills to the city, but *with the worst intentions*.
...
*(Page numbers in parentheses following quotes refer to
...
clearer “Empire constitutes the ontological fabric”[7] (p. 354). What
...
its foul[8] order; the antitheses are the subjects, the “multitude”,
...
19th century. Any idea of class struggle, of the subversion
...
unity of measure,[9] no matter how generous it may appear or be. This
...
with fingerprints![10]). The second is the one that they do not
...
does not endlessly conjugate the imperial Verb to the infinitive.[11]
...
that which is Unknown back to that which is State.[12]
...
[1] This parallels the perspectives of many neo-racists who base their ideology on “culture” and “ethnicity” rather than on skin color and “blood”.

[2] A *lingua franca* is a hybrid language of the sort that often develops in places of international commerce — such as port cities — to allow communication.

[3] An international tax on currency speculation. — translator

[4] *Ya Basta!*, the White Overalls and the Disobedient — all Negrian “radicals” — have carried out this function in a number of demonstrations in Italy, denouncing those who attacked banks, multi-national businesses, etc. to the cops. — translator

[5] The Italian word, *potenza*, can be translated as power, potency, might, force, sway or *empire*. — translator

[6] A leftist politician, formerly in the Communist Party of Italy, now part of the Left Democratic party, who speaks with every one from White Overalls to fascists.

[7] In Italian, this word “fabbrica”, usually means “factory”. — translator

[8] In Italian there is a play on words here — “immondo” is the Italian word for “foul”; “mondo” is the Italian word for “world”.

[9] In Italian, there is a play on words in this sentence: “excess” is “*dismisura*” in Italian and “measure” is “*misura*”, which, according to my dictionary can also mean “limit” or “standard”.

[10] The Italian state is going to require fingerprints on all new identification documents.

[11] The Italian phrase is “...coniuga all’ infinito il Verbo imperiale” with a wordplay on “all’infinito” which means both “the infinitive” and “endlessly”.

[12] In Italian this is a wordplay “riportando ciò che è Ignoto a ciò che è Stato” can also mean “bring the Unknown back to that which has been”. The idea is that if we storm the unknown, the state will be a thing of the past.
