---
title: "Chaotic Variables: A Theoretical Contribution In Proposal for an Informal Anarchist Platform - CCF – Metropolitan Violence Cell"
...
page_type: book
mirror_state: full
description: "1) Disobedience is a virtue “You are obliged to pretend to respect people and institutions that you consider irrational. You live by fashion in a cowardly era, attached to ethical and social conventions you despise, that you condemn and yo"
tags:
  - "history"
  ...
  - "pdf"
files:
  - name: "Chaotic Variables.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-ccf-metropolitan-violence-cell-chaotic-variables.pdf"
    hosted: true
  - name: "Chaotic Variables.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-ccf-metropolitan-violence-cell-chaotic-variables.epub"
    hosted: true
---

# Chaotic Variables: A Theoretical Contribution In Proposal for an Informal Anarchist Platform
...
We believe that one of the things that helped in spreading Black December so much was that **the two comrades’ call was open enough for everyone to be able to shape it.** Also, the perspective of multiformed action without prioritizing one means over the other, we believe freed up even more possibilities which became understood. Of course, comrades Nikos Romanos and Panagiotis Argyros, together with the other members of the Conspiracy from the A wing that accompanied the proposal either theoretically or in practice, had originally declared that **they perceived Black December as an experiment, practically a “pilot” to test in practice the possibilities of an informal anarchist action** coordination platform, on the principles of political autonomy **of collectives and individualities** and on those of polymorphy.
