---
title: "The “Ceasefire” Is a Deadly Fraud: A Message from a Comrade in Rojava - CrimethInc."
author: "CrimethInc."
...
page_type: book
mirror_state: full
description: "The supposed ceasefire announced by US Vice President Mike Pence is a deadly fraud. Its only purpose is to enable the Trump administration to wash its hands of the bloodshed that the Turkish military is perpetrating while shifting the disco"
tags:
  - "history"
  - "Syrian civil war"
  - "Rojava"
  ...
  - "pdf"
files:
  - name: "The “Ceasefire” Is a Deadly Fraud.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-crimethinc-the-ceasefire-is-a-deadly-fraud.pdf"
    hosted: true
  - name: "The “Ceasefire” Is a Deadly Fraud.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-crimethinc-the-ceasefire-is-a-deadly-fraud.epub"
    hosted: true
---
...
JOINT TURKISH-US STATEMENT ON NORTHEAST SYRIA
 ...
 1. Turkey and the US agree that the conditions on the ground, northeast Syria in particular, necessitate closer coordination on the basis of common interests.
 ...
 1. The two countries reiterate their pledge to uphold human life, human rights, and the protection of religious ethnic communities.

 1. Turkey and the US are committed to D-ISIS/DAESH activities in northeast Syria. This will include coordination of detention facilities and internally displaced persons form formerly ISIS/DAESH-controlled areas, as appropriate.

 1. Turkey and the US agree that counter-terrorism operations must target only terrorists and their hideouts, shelters, emplacements, weapons, vehicles and equipment.

 1. The Turkish side expressed its commitment to ensure safety and well-being of residents of all population centers in the safe zone controlled by the Turkish Forces (safe zone) and reiterated that maximum care will be exercised in order not to cause harm to civilians and civilian infrastructure.

 1. Both countries reiterate their commitment to the political unity and territorial integrity of Syria and UN-led political process, which aims at ending the Syrian conflict with in accordance UNSCR 2254.

 1. The sides agreed on the continued importance and functionality of a safe zone in order to address the national security concerns of Turkey, to include the re-collection of YPG heavy weapons and the disablement of their fortifications and all other fighting positions.

 1. The safe zone will be primarily enforced by the Turkish Armed Forces and the two sides will increase their cooperation in all dimensions of its implementation.

 1. The Turkish side will pause Operation Peace Spring in order to all the withdrawal of YPG from the safe zone within 120 hours. Operation Peace Spring will be halted upon completion of this withdrawal.

 1. Once Peace Spring is paused, the US agrees not to purse further imposition of sanctions under the Executive Order of October 14, 2019, *Blocking Property and Suspending Entry of Certain Persons Contributing to the Situation in Syria,* and will and consult with Congress, as appropriate, to underline the progress being undertaken to achieve peace and security in Syria, in accordance with UNSCR 2254. Once Operation Peace Spring is halted as per paragraph 11 the current sanctions under the aforementioned Executive Order shall be lifted.

 1. Both parties are committed to work together to implement all the goals outlined in this Statement.
