---
title: "Animal liberation: Let’s put veganism aside and relaunch the struggle - Unknown"
author: "Unknown"
...
page_type: book
mirror_state: full
description: "We are not writing this piece to start a debate within the antispecist movement (which is dead and buried under the weight of its chatter, self-proclaimed spokespersons and philosophic rhetoric) but to highlight the fact that there are indi"
tags:
  - "theory"
  - "Italy"
  - "animal liberation"
  ...
  - "pdf"
files:
  - name: "Animal liberation.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-animal-liberation.pdf"
    hosted: true
  - name: "Animal liberation.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-animal-liberation.epub"
    hosted: true
---

# Animal liberation: Let’s put veganism aside and relaunch the struggle
