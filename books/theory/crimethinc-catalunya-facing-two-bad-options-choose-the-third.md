---
title: "Catalunya: Facing Two Bad Options, Choose the Third: On the Showdown between Spain and Catalunya - CrimethInc."
author: "CrimethInc."
...
page_type: book
mirror_state: full
description: "The Catalan president, Carles Puigdemont, played for time today, suspending the declaration of independence mandated by the referendum in order to continue negotiations with the central government of Spain, the European Union, and—presumabl"
tags:
  - "theory"
  ...
  - "pdf"
files:
  - name: "Catalunya: Facing Two Bad Options, Choose the Third.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-crimethinc-catalunya-facing-two-bad-options-choose-the-third.pdf"
    hosted: true
  - name: "Catalunya: Facing Two Bad Options, Choose the Third.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-crimethinc-catalunya-facing-two-bad-options-choose-the-third.epub"
    hosted: true
---
...
Your “untimely perplexities” are the greatest exponent I have read of common sense and of the revolutionary *seny*4 which should reign not only among anti-authoritarians, but among all who wish to abolish this society rather than managing it.
...
It is characteristic of philistine anarchism, in the face of any minor historical dilemma, to opt for playing the game with the established Power. The Spanish Civil War is a clear example of this. Confusion, the irresistible attraction of the racket [i.e., taking positions within the state], losing class-based structures, the lesser of two evils, the enemy of my enemy, whatever.
