...
page_type: book
mirror_state: full
description: "Coming together. Speaking to each other. a project of the Terms of Endearment Research Syndicate “Nothing can be more depressing than to expose, naked to the light of thought, the hideous growth of argot. Indeed it is like a sort of repelle"
tags:
  - "theory"
  - "cities"
  - "language"
  - "pdf"
files:
  - name: "Cabal, Argot.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-anonymous-cabal-argot.pdf"
    hosted: true
  - name: "Cabal, Argot.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-anonymous-cabal-argot.epub"
    hosted: true
---
