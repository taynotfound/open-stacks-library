---
title: "A Gang with an Analysis - Committee on Higher Education (C.H.E.)"
...
page_type: book
mirror_state: full
description: "This is the story of the birth and death--and revival, of a grouplet, a Committee on Higher Education, C.H.E. This is an act of consciousness and an action; it is theory and practice. This is the critical self-analysis that revives C.H.E.,"
tags:
  - "theory"
  - "student movement"
  - "ideology"
  ...
  - "pdf"
files:
  - name: "A Gang with an Analysis.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-committee-on-higher-education-c-h-e-a-gang-with-an-analysis.pdf"
    hosted: true
  - name: "A Gang with an Analysis.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-committee-on-higher-education-c-h-e-a-gang-with-an-analysis.epub"
    hosted: true
---

# A Gang with an Analysis

*by Committee on Higher Education (C.H.E.)*

> Scanned from original.

[This is the story of the birth and death--and revival, of a grouplet, a Committee on Higher Education, C.H.E. This is an act of consciousness and an action; it is theory and practice. This is the critical self-analysis that revives C.H.E., the analysis that gives this gang a new direction.]
...
ARE YOU GOING TO FALL WITH IT? OR ARE YOU GOING TO LEARN WHAT’S GOING ON AND PREPARE?
...
IT IS OUR RESPONSIBILITY TO MAKE IT RELEVANT TO OUR LIVES.

DEMAND THAT YOUR CLASSES BE RELEVANT OR BOYCOTT!

SUPPORT STUDENT INITIATIVE FOR RELEVANT CURRICULUM IN EVERY DEPARTMENT!

DEMONSTRATE FOR STUDENTS’ RIGHT TO DEMAND THAT CURRICULUM THEY WANT...AND TO GET IT!
...
CONFRONT THE ISSUE: DEBATE TODAY FROM 3:00 to 5:00 in 2303 SANGREN.
...
THE COUNCIL OF HIGHER EDUCATION DEMANDS AND WILL DESIGN AND IMPLEMENT A STUDENT DEPARTMENT BASED ON SELF AWARENESS AND AUTHENTICITY IN THE TWENTIETH CENTURY
