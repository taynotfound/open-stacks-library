---
title: "An Attack on All of Us: How the Right Hopes to Use the Shooting in Alexandria - CrimethInc."
author: "CrimethInc."
date: "June 15, 2017"
category: "theory"
...
page_type: book
mirror_state: full
description: "Those who wish to carry out acts of violence always seek to frame themselves as victims. If they are perceived as victims, this can legitimize the violence they perpetrate, or at least distract from it. So it was a godsend for the far right"
tags:
  - "theory"
  - "violence"
  - "guns"
  ...
  - "pdf"
files:
  - name: "An Attack on All of Us.pdf"
    type: "PDF"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-crimethinc-an-attack-on-all-of-us.pdf"
    hosted: true
  - name: "An Attack on All of Us.epub"
    type: "EPUB"
    url: "https://raw.githubusercontent.com/taynotfound/open-stacks-library/main/files/tal-crimethinc-an-attack-on-all-of-us.epub"
    hosted: true
---

# An Attack on All of Us: How the Right Hopes to Use the Shooting in Alexandria
...
This is not the kind of war that the far right are calling for, pitting different factions and demographics against each other in a zero-sum race to annihilation. It is a revolution, aimed at transforming the ways we relate to each other and understand ourselves. In attempting to bring about a revolution, we will encounter adversaries, but we must not understand them as enemies.
